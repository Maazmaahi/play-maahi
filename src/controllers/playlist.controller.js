...
const getUserPlaylists = asyncHandler(async (req, res) => {
  ...
  res
    .status(200)
    .json(
      new ApiResponse(200, getUserPlaylists, "playlists found successfully")
    );
});
...
const getPlaylistById = asyncHandler(async (req, res) => {
  ...
  res
    .status(200)
    .json(
      new ApiResponse(200, getUserPlaylist, "playlists found successfully")
    );
});
...
const addVideoToPlaylist = asyncHandler(async (req, res) => {
  ...
  res.status(200).json(new ApiResponse(200, videoAdded, "video added"));
});
...
const deletePlaylist = asyncHandler(async (req, res) => {
  ...
  res
    .status(200)
    .json(new ApiResponse(200, playlist, "playlist removed from database"));
});
